...
class SearchQuery {
	...
	static or: (sq1: SearchQuery | string | null, sq2: SearchQuery | string | null) => SearchQuery;
 ...
 * @returns a NEW SearchQuery
 */
SearchQuery.or = (sq1: SearchQuery | string | null, sq2: SearchQuery | string | null): SearchQuery => {
