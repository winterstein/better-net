 ...
 */
export function extractChunksThreads(source: Document | Element | string, url, options: any = {}) {
  const {
    minTextLength = 100,
    maxChunks = 50,
    includeAds = false
 ...
 */
function extractThreadsChunk(container, linkElement, linkRegex, pageUrl, options: any = {}) {
