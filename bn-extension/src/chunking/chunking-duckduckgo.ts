 ...
 */
export function extractChunksDuckDuckGo(source: Document | Element | string, url, options: any = {}) {
	const {
		minTextLength = 100,
		maxChunks = 50,
		includeAds = false
 ...
 */
function extractDDGChunk(element: Element, linkRegex, pageUrl, options: any = {}) {
