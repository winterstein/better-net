 ...
 */
export function extractChunksFacebook(source: Document | Element | string, url, options: any = {}) {
  const {
    minTextLength = 100,
    maxChunks = 50,
    includeAds = false
 ...
 */
function extractFacebookChunk(container, linkElement, linkRegex, pageUrl, options: any = {}) {
